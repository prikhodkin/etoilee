...
var modal = document.querySelector(".cookies");
...
var addIsFirstInfo = function addIsFirstInfo() {
  var acceptButton = modal.querySelector(".button--grad");
  var denyButton = modal.querySelector(".button--white");
...
var map = {
	...
	"./slider-fixed_controller.js": "./src/js/controllers/slider-fixed_controller.js",
	"./slider-one_controller.js": "./src/js/controllers/slider-one_controller.js",
	"./slider-two_controller.js": "./src/js/controllers/slider-two_controller.js",
...
/***/ "./src/js/controllers/slider-fixed_controller.js":
/*!*******************************************************!*\
  !*** ./src/js/controllers/slider-fixed_controller.js ***!
  \*******************************************************/
/*! exports provided: default */
...
/***/ "./src/js/controllers/slider-one_controller.js":
/*!*****************************************************!*\
  !*** ./src/js/controllers/slider-one_controller.js ***!
  \*****************************************************/
/*! exports provided: default */
...
/***/ "./src/js/controllers/slider-two_controller.js":
/*!*****************************************************!*\
  !*** ./src/js/controllers/slider-two_controller.js ***!
  \*****************************************************/
/*! exports provided: default */
...
application.load(Object(stimulus_webpack_helpers__WEBPACK_IMPORTED_MODULE_1__["definitionsFromContext"])(context)); //Открыть меню
...
var companyCardButton = document.querySelector(".company-card__button");
var companyCardText = document.querySelector(".company-card__text");
...
var nav = jquery__WEBPACK_IMPORTED_MODULE_3___default()('.sidebar');
var promo = jquery__WEBPACK_IMPORTED_MODULE_3___default()(".promo");
jquery__WEBPACK_IMPORTED_MODULE_3___default()(window).on('scroll', function () {
  var cur_pos = jquery__WEBPACK_IMPORTED_MODULE_3___default()(this).scrollTop();
  ...
  sections.each(function () {
    var top = jquery__WEBPACK_IMPORTED_MODULE_3___default()(this).offset().top,
        bottom = top + jquery__WEBPACK_IMPORTED_MODULE_3___default()(this).outerHeight();
    ...
    if (cur_pos >= top && cur_pos <= bottom) {
      ...
      nav.find('a[href="#' + jquery__WEBPACK_IMPORTED_MODULE_3___default()(this).attr('id') + '"]').addClass('active');
    }
  });
});
nav.find('a').on('click', function () {
  var $el = jquery__WEBPACK_IMPORTED_MODULE_3___default()(this),
      id = $el.attr('href');
  jquery__WEBPACK_IMPORTED_MODULE_3___default()('html, body').animate({
    scrollTop: jquery__WEBPACK_IMPORTED_MODULE_3___default()(id).offset().top - nav_height
  }, 500);
  return false;
});
